...
5. ? **PR Template Created**
   - `documentation/process/documentation/process/PR_OCR_FEATURE.md` - Ready for PR creation
...
1. **Create PR** using `documentation/process/documentation/process/PR_OCR_FEATURE.md` as template
...
**Description**: Use content from `documentation/process/documentation/process/PR_OCR_FEATURE.md`
