...
Use the PR details from `PR-DETAILS.md`:
...
3. Copy the content from `PR-DETAILS.md`
...
### Files to Reference:
- `PR-DETAILS.md` - Complete PR description
- `PROJECT-STATUS.md` - Project context
- `docs/tailwind-v4-guide.md` - Technical details
